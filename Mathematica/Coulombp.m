...
WaveA[l_,m_,theta_,phi_]:=Module[{tmp},tmp=SphericalHarmonicY[l,m,theta,phi]]
WaveF[Z_,r_,n_,l_,m_,theta_,phi_]:=Module[{tmp},tmp=WaveR[Z,r,n,l] WaveA[l,m,theta,phi]]
End[]
EndPackage[]
